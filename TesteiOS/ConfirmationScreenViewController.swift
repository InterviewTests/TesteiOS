...
//  TesteSantander
//
//  Created by Marcel Mendes Filho on 05/05/2018.
...
class ConfirmationScreenViewController: UIViewController {
    ...
    {
        NotificationCenter.default.post(name: Notification.Name(rawValue: localNotificationKey002), object: self, userInfo: nil)
    }
