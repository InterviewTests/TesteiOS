...
class InvestmentWorkerTests: XCTestCase
{
  ...
  // MARK: Tests
    ...
    func testFetchShouldAskAPIClientToFetchFund()
    {
        // Given
        ...
        // When
        sut.fetchFund { (fund, error) in }
        
        // Then
        XCTAssertTrue(api.fetchCalled, "fetch(completionHandler:) should ask API Client to fetch Fund")
    }
}
