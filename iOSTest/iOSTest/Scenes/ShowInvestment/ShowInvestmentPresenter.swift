...
class ShowInvestmentPresenter: ShowInvestmentPresentationLogic {
    ...
    func presentInvestmentInfo(response: ShowInvestment.GetInvestmentInfo.Response) {
        ...
        let titleInfo = ShowInvestment.GetInvestmentInfo.ViewModel.TitleInfo(title: investment.title, fundName: investment.fundName, whatIs: investment.whatIs, definition: investment.definition, riskTitle: investment.riskTitle, risk: getRiskIndex(risk: investment.risk))
    ...
    func getRiskIndex(risk: Int) -> Int {
        switch risk {
        case 1:
            return Risk.veryLow.rawValue
        case 2:
            return Risk.low.rawValue
        case 3:
            return Risk.middle.rawValue
        case 4:
            return Risk.high.rawValue
        default:
            return Risk.veryHigh.rawValue
        }
    }
}
