...
struct Seeds
{
    struct Cells
    {
        ...
        static let secondCell = Cell.init(id: 2, type: Type.field, message: "message@host.com.br", typeField: TypeField.email, hidden:false, topSpacing: 30.0, show: 1, required: true)
        static let thirdCell = Cell.init(id: 3, type: Type.field, message: "(11) 99999-9999", typeField: TypeField.telNumber, hidden:false, topSpacing: 30.0, show: 1, required: false)
    }
